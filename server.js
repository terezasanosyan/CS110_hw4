'use strict'
    ...
    let todos =[
      {id:Math.random()+'',message:"Get up at 6am",completed:false},
      {id:Math.random()+'',message:"Have a coffee",completed:false},
      {id:Math.random()+'',message:"Go to AUA",completed:false}
    ];
